...
Liczba pojedyncza versus mnoga. <- Cassimir vs Cassimir + Adelaide

Kurt Reidemeister pełne imię -> Kurt Werner Friedrich Reidemeister

Wykorzystać diagramy z knot-plot do lepszego pokazania, czym są kolorowania (będzie to kolejny powód, dlaczego książka tym razem zostanie wydrukowana w kolorze).