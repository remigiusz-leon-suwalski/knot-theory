...
Pojęcie sumy spójnej węzłów (oraz opisane później satelity) wprowadził do matematyki Schubert \cite{schubert49}.
...
\begin{itemize}
    ...
    Fox twierdzi, że Seifert \cite{seifert33} wiedział o tym.
    Pokazał też w~króciutkim artykule \cite{fox52}, że ich dopełnienia nie są homeomorficzne.
    ...
    Cromwell \cite[s. 90]{cromwell04} pokazuje przykład dwóch niewęzłów, z~których otrzymano niepoprawnie dwie różne sumy, $6_1$ oraz $8_{20}$.
\end{itemize}
