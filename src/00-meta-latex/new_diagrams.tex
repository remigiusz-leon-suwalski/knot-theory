...
\newcommand{\MediumThikkJustSmoothing} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.06001]
    \begin{knot}[clip width=7, end tolerance=1pt]
        \useasboundingbox (-7, -5) rectangle (7, 5); % REMOVE ME
...
\newcommand{\LargeThikkJustSmoothing} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.15001]
    \begin{knot}[clip width=6, end tolerance=1pt]
        \useasboundingbox (-7, -5) rectangle (7, 5); % REMOVE ME
        \draw[ultra thick,-latex] (-5, -5) to [out=45, in=-45] (-5, 5);
        \draw[ultra thick,-latex] (5, -5) to [out=135, in=-135] (5, 5);
...
\newcommand{\HugeOldWirtingerPlus} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.25001]
    \begin{knot}[clip width=4.5, end tolerance=1pt, flip crossing/.list={1}]
        \useasboundingbox (-7, -5) rectangle (7, 5); % REMOVE ME
...
\newcommand{\SmallWirtingerPlus} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.03001]
    \begin{knot}[clip width=5, end tolerance=1pt]
        \useasboundingbox (-5, -5) rectangle (5, 5); % REMOVE ME
        \strand[ultra thick, -latex] (-5, -5) to (6, 6);
...
\newcommand{\MediumWirtingerPlus} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.06001]
    \begin{knot}[clip width=5, end tolerance=1pt]
        \useasboundingbox (-7, -5) rectangle (7, 5); % REMOVE ME
        \strand[ultra thick, -latex] (-5, -5) to (6, 6);
        \strand[ultra thick, latex-] (-6, 6) to (5, -5);
...
\newcommand{\LargeWirtingerPlus} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.15001]
    \begin{knot}[clip width=5, end tolerance=1pt]
        \useasboundingbox (-7, -5) rectangle (7, 5); % REMOVE ME
        \strand[ultra thick, -latex] (-5, -5) to (6, 6);
        \strand[ultra thick, latex-] (-6, 6) to (5, -5);
...
\newcommand{\SmallWirtingerMinus} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.03001]
    \begin{knot}[clip width=5, end tolerance=1pt, flip crossing/.list={1}]
        \useasboundingbox (-5, -5) rectangle (5, 5); % REMOVE ME
        \strand[ultra thick, -latex] (-5, -5) to (6, 6);
        \strand[ultra thick, latex-] (-6, 6) to (5, -5);
...
\newcommand{\MediumWirtingerMinus} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.06001]
    \begin{knot}[clip width=5, end tolerance=1pt, flip crossing/.list={1}]
        \useasboundingbox (-7, -5) rectangle (7, 5); % REMOVE ME
        \strand[ultra thick, -latex] (-5, -5) to (6, 6);
        \strand[ultra thick, latex-] (-6, 6) to (5, -5);
...
\newcommand{\LargeWirtingerMinus} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.15001]
    \begin{knot}[clip width=5, end tolerance=1pt, flip crossing/.list={1}]
        \useasboundingbox (-7, -5) rectangle (7, 5); % REMOVE ME
        \strand[ultra thick, -latex] (-5, -5) to (6, 6);
        \strand[ultra thick, latex-] (-6, 6) to (5, -5);
...
\newcommand{\HugeOldWirtingerMinus} {\begin{tikzpicture}[baseline=-0.65ex, scale=0.25001]
    \begin{knot}[clip width=4.5, end tolerance=1pt, flip crossing/.list={1}]
        \useasboundingbox (-7, -5) rectangle (7, 5); % REMOVE ME
        \strand[very thick, latex-] (-6,6) to (5,-5);
        \strand[very thick, latex-] (-6,-6) to (5,5);
