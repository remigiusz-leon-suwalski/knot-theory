...
Lwia część analizy węzłów o 12 skrzyżowaniach została wykonana przez Stojmenowa i~Hirasawę, jak podaje baza danych KnotInfo \cite{knotinfo24}.
...
n
\begin{proposition}
    Niech $f$ cybędzie epimorfizmem grupy splotu $L$ na nieskończoną grupę cykliczną, który posyła każdy południk na jej generator $t$. % each meridian
