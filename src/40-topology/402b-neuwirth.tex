...
\begin{proposition}
    Niech $L$ będzie splotem, $\pi$ jego grupą podstawową, zaś $f \colon \pi \to \Z$ pewnym epimorfizmem, który posyła każdy południk na generator $t$ grupy $\Z$. % each meridian % TODO!!! meridian longitute latitude
