...
Wreszcie Jones zauważył \cite[tw. 19]{jones1985}, że dzięki zespolonym algebrom Clifforda oraz pracy Lannesa \cite{lannes1985} niezmiennik Arfa jest specjalną wartością wielomianu Jonesa.
...
\begin{proof}
    Wynika to z faktu \ref{prp:arf_jones} oraz \ref{prp:jones_multiplicative_2} % , ale bezpośredni dowód też istnieje. akomentowane, bo jednak nie wiem, gdzie
\end{proof}
