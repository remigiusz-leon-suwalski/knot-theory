...
Dwa węzły nazwiemy równoważnymi przez przejścia, jeśli są związane skończenie wieloma ,,przejściami'' \cite[s. 143]{kauffman1983}:
\begin{comment}
\[
...
Wreszcie Jones zauważył \cite[tw. 19]{jones1985}, że dzięki zespolonym algebrom Clifforda oraz pracy \cite{lannes1985} niezmiennik Arfa jest specjalną wartością wielomianu Jonesa.
