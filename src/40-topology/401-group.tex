...
\begin{proof}
    Niech $K_1, K_2$ będą równoważnymi węzłami.
    Wtedy istnieje izotopijny z~identycznością homeomorfizm $f \colon \R^3 \to \R^3$, który posyła pierwszy węzeł na drugi: $f(K_1) = K_2$.
    Obcięty do dopełnień węzłów indukuje izomorfizm grup podstawowych $\pi(K_1) \cong \pi(K_2)$.
\end{proof}
