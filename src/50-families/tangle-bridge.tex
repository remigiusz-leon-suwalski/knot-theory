...
Mają one co najwyżej dwa ogniwa i~są odwracalne \cite[s. 211]{burde14}.
Pierwsi studiowali je Bankwitz, Schumann \cite{schumann34} w~1934 roku jako \emph{Viergeflechte}.
...
Więcej informacji podaje Kawauchi \cite[s. 21-26]{kawauchi96}.
