...
Sami nie rozumiemy go zbyt dobrze, dlatego zreferujemy tylko tekst Kawauchiego \cite[s. 154-169]{kawauchi1996} i nie podamy ulubionego odniesienia do tematu w~literaturze.
...
\index{węzeł!Conwaya}
Wśród pierwszych węzłów do dwunastu skrzyżowań najdłużej opierał się węzeł Conwaya, aż Lisa Piccirillo \cite{piccirillo2020} pokazała, że nie jest plastrowy.
...
\begin{proof}
    Kawauchi \cite[s. 155]{kawauchi1996} pisze: wybierzmy 3-kulę $B \subseteq S^3$ taką, że $K \cap B$ jest trywialnym łukiem w $B$.
...
\begin{tobedone}[Szkic dowodu]
    ...
    Patrz też twierdzenie 8.8 z~artykułu \cite{murasugi1965}.
...
% Twierdzenie łatwo napotkać czytając o węzłach plastrowych, ale jawnie nikomu się nie chce wskazać dowodu. Informację, że to jest tw. 1.13b znalazłem wreszcie w https://arxiv.org/pdf/1504.01064.pdf
    Freedman w \cite[tw. 1.13]{freedman1982}.
\end{proof}
...
Wydawało mi się kiedyś, że Gompf \cite{gompf1986} dobrze tłumaczy tę różnicę przy użyciu twierdzenia Donaldsona.
