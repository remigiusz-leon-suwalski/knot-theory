...
Przeczytaliśmy przeglądową pracę Kalfagianniego, Futera oraz Purcell \cite{purcell19}, notatki z~wykładów prowadzone przez samą Purcell i~wreszcie książkę \cite{purcell20}, jaka z~nich wyrosła.
...
Wystarczy nam starszy wynik samego Thurstona \cite{thurston82}, który zajął się szczególnym przypadkiem rozmaitości Hakena.
...
\begin{proof}[Niedowód]
    Thurston \cite[s. 360]{thurston82} dowodzi ogólniejszego faktu: wnętrze zwartej 3-rozmaitości z~niepustym brzegiem $M$ ma strukturę hiperboliczną wtedy i tylko wtedy, gdy rozmaitość $M$ jest homotopijnie atoroidalna, pierwsza oraz nie jest homeomorficzna z $T^2 \times I / (\Z/2)$, gdzie $\Z/2$ odwraca $I$.
...
\begin{proof}[Niedowód]
    Menasco \cite{menasco84} pokazał: dopełnienie alternującego węzła nie zawiera nieściśliwych nieperyferyjnych torusów.
...
Purcell \cite[s. 66]{purcell20} w formie ćwiczenia proponuje znaleźć rodzinę zupełnych struktur hiperbolicznych na nakłutym torusie oraz czterokrotnie nakłutej sferze.
