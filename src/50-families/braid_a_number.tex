...
Według bazy danych LinkInfo \cite{linkinfo24} istnieją 1424 niezorientowane sploty pierwsze o indeksie skrzyżowaniowym 11 lub mniejszym.
...
% zweryfikować z ./tools/knotinfo_parsed.json programem w Pythonie
