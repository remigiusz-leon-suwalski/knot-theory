...
\begin{definition}[węzeł Lissajous]
    Niech $n_x, n_y, n_z$ (,,częstotliwości'') będą liczbami całkowitymi, zaś  $\varphi_x, \varphi_y, \varphi_z$ (,,fazy'') liczbami rzeczywistymi.
    Wtedy węzeł zadany w przestrzeni $\R^3$ parametrycznie:
    \begin{equation}
...
W 1999 Lamm, Obermeyer \cite{obermeyer1999} dowiedli, że węzły bilardowe wewnątrz walca są taśmowe albo okresowe, więc w walcu nie można zrealizować każdego węzła.
