...
\begin{figure}[H]
    \begin{minipage}[b]{.3\linewidth}
        ...
        \subcaption{trójlistnik: $p = 3, q = 2$}
    \end{minipage}
    \begin{minipage}[b]{.3\linewidth}
        \centering
...
% f[ppp_, qqq_] := ParametricPlot3D[{Cos[2 Pi ppp t] (2 + Cos[2 Pi qqq t]), (2 + Cos[2 Pi qqq t]) Sin[2 Pi ppp t], -Sin[2 Pi qqq t]}, {t, 0, 1}, ColorFunction -> "ValentineTones", PlotStyle -> Thickness[0.02], Boxed -> False, Axes -> False];
% f[3, 2]
% f[3, 8]
% f[8, 3]
...
% TODO: https://mathscinet.ams.org/mathscinet-getitem?mr=96236
...
Burde, Zieschang, Heusener \cite[s. 85]{burde2014} piszą, że Waldhausen
\index[persons]{Waldhausen, Friedhelm}%
znacznie uogólnił wynik: jeśli $M$ jest orientowalną, zwartą, nierozkładalną 3-rozmaitością taką, że grupa $H_1(M)$ jest nieskończona lub $\pi_1 M$ jest nietrywialnym produktem wolnym z amalgamacją i $\pi_1 M $ ma nietrywialne centrum, to $M$ jest włóknistą rozmaitością Seiferta z orientowalnym orbifoldem.
\index{orbifold}%
