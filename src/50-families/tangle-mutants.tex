...
Warto przytoczyć teraz obserwację 3.8.2 z \cite[s. 43]{kawauchi96} pochodzącą tak naprawdę z pracy Viro \cite{viro73}: jeśli sploty $L_1, L_2$ są mutantami, to podwójne przestrzenie nakryciowe nad $S^3$ rozgałęzione odpowiednio wzdłuż $L_1$ oraz $L_2$ są homeomorficzne z zachowaniem orientacji.
Cooper \cite{cooper82} zauważył w swojej pracy doktorskiej, że macierze Seiferta mutantów są $S$-równoważne.
