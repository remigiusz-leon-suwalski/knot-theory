...
\end{equation}
Kinoshita, Terasaki zdefiniowali nieskończoną rodzinę węzłów o trywialnym wielomianie Alexandera, której pierwszym wyrazem jest węzeł $11n_{42}$ w~\cite{kinoshita1957}.
...
\begin{proof}
    \cite{tanaka2009}, choć nie wiem gdzie dokładnie.
\end{proof}
...
\begin{proof}
\index[persons]{Ruberman, Daniel}%
    Jeszcze raz Ruberman, w \cite{ruberman1999}.
\end{proof}
